...
- The [low-risk document review workflow](docs/document-review-workflow.md) draft defines the PHARMA-P2-001 synthetic / copied sample context workflow, read-only input posture, draft-only output posture, human approval checkpoint, rejection / revocation handling, and validation-package mapping notes.
- The [training task routing workflow](docs/training-task-routing-workflow.md) draft defines the PHARMA-P2-002 synthetic / copied sample context workflow, read-only input posture, draft-only routing suggestions, human approval checkpoint, rejection / revocation handling, and validation-package mapping notes.
